...
# DTB - either prebuilt dtb.img or included in boot
BOARD_PREBUILT_DTB_IMAGE := $(DEVICE_PATH)/prebuilt/dtb.img  # Use this if file exists
# OR if no dtb.img file:
...
# Include dtb in boot image if no prebuilt dtb.img
BOARD_INCLUDE_DTB_IN_BOOTIMG := true
